...
# Input data
num_of_balls_played = np.array([12,9,21,7,20,8,18,16,15,8,29,10,14,17,31,21])
num_of_runs_made = np.array([22,18,40,10,45,11,35,30,25,12,55,15,20,28,60,33])
overs_bowled = np.array([0])
runs_conceded = np.array([0])
wickets_taken = np.array([0])
dismissals = np.array([0,0,0,0,1,0,0,0,1,0,1,0,1,0,2,0])
